...
describe('Redactor::fake()', function (): void {
    it('swaps the facade and the container binding and still redacts', function (): void {
        $fake = Redactor::fake();

        expect(resolve(RedactorService::class))->toBe($fake)
    ...
    it('proves a secret never left, across every call and profile', function (): void {
        $fake = Redactor::fake();
    ...
    it('fails loudly when a secret did get out', function (): void {
        $fake = Redactor::fake();
    ...
    it('fails when nothing was redacted but something should have been', function (): void {
        $fake = Redactor::fake();
    ...
    it('records what went through the Monolog processor', function (): void {
        $fake = Redactor::fake();
        $processor = new RedactorProcessor(resolve(RedactorService::class));
    ...
    it('can forget and be asserted empty', function (): void {
        $fake = Redactor::fake();
        Redactor::redact('x');
        $fake->forget();
